require([
    ...
    const hotelsLayer = new FeatureLayer({
        url: "https://services9.arcgis.com/j9Cwpg1kdJBl1jL4/arcgis/rest/services/grandes_surface/FeatureServer/0",
        outFields: ["Adresse", "Type"],
        popupTemplate: {
            title: "{Adresse}",
            content: "<b>ADRESSE:</b> {Adresse}<br><b>TYPE:</b> {Type}",
        },
    ...
    function displayResults(results) {
        ...
        results.features.forEach((feature) => {
            ...
            const graphic = new Graphic({
                ...
                popupTemplate: {
                    title: "Hotel {HOTEL}",
                    content: "ADRESSE: {Adresse}<br>TYPE: {Type}",
                },
            });
